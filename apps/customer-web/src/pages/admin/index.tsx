    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="card">
                    <div className="card-header"><div><h3 className="font-semibold text-gray-900">Top sản phẩm</h3><p className="text-xs text-gray-500 mt-0.5">Doanh thu cao nhất</p></div><Link href="/admin/products" className="text-xs text-primary-600 hover:underline font-medium">Xem tất cả</Link></div>
                ...
                <div className="card">
                    <div className="card-header"><div><h3 className="font-semibold text-gray-900">Xếp hạng cửa hàng</h3><p className="text-xs text-gray-500 mt-0.5">Doanh thu theo cửa hàng</p></div><Link href="/admin/stores" className="text-xs text-primary-600 hover:underline font-medium">Xem tất cả</Link></div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="card">
                    <div className="card-header"><div><h3 className="font-semibold text-gray-900">Đơn hàng gần đây</h3><p className="text-xs text-gray-500 mt-0.5">5 đơn hàng mới nhất</p></div><Link href="/admin/orders" className="text-xs text-primary-600 hover:underline font-medium">Xem tất cả</Link></div>
                ...
                <div className="card">
                    ...
                    <div className="card-body"><div className="grid grid-cols-2 sm:grid-cols-4 gap-3">{[
                        { icon: '🎫', label: 'Tạo Voucher', href: '/admin/vouchers', color: 'bg-purple-50 text-purple-600', desc: 'Khuyến mãi mới' },
                        { icon: '🔔', label: 'Gửi thông báo', href: '/admin/notifications', color: 'bg-blue-50 text-blue-600', desc: 'Push notification' },
                        { icon: '📦', label: 'Thêm sản phẩm', href: '/admin/products', color: 'bg-green-50 text-green-600', desc: 'Quản lý SP' },
                        { icon: '🏪', label: 'Thêm cửa hàng', href: '/admin/stores', color: 'bg-orange-50 text-orange-600', desc: 'Đăng ký mới' },
                        { icon: '📊', label: 'Báo cáo', href: '/admin/reports', color: 'bg-red-50 text-red-600', desc: 'Xuất báo cáo' },
                        { icon: '🎪', label: 'Sự kiện mới', href: '/admin/events', color: 'bg-pink-50 text-pink-600', desc: 'Tổ chức sự kiện' },
                        { icon: '👥', label: 'Người dùng', href: '/admin/users', color: 'bg-indigo-50 text-indigo-600', desc: 'Quản lý user' },
                        { icon: '⚙️', label: 'Cài đặt', href: '/admin/settings', color: 'bg-gray-50 text-gray-600', desc: 'Cấu hình hệ thống' },
